...
public sealed class MembersWithActiveMembershipsSpecification : Specification<Member>
{
	public MembersWithActiveMembershipsSpecification():
		base(m => m.Memberships.Count == 1)
	{
