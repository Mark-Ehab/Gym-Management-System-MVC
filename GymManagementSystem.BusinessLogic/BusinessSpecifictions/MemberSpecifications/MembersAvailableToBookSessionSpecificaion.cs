...
public sealed class MembersAvailableToBookSessionSpecificaion : Specification<Member>
{
    public MembersAvailableToBookSessionSpecificaion(IEnumerable<Guid> nonAvailableMembersToBookSessionIds)
        :base(m => !nonAvailableMembersToBookSessionIds.Contains(m.Id) && m.Memberships.Count == 1)
    {
